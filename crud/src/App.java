...
public class App {
    ...
    public static void main(String args[]) {
        ...
        String opcao = JOptionPane.showInputDialog(null, "Digite 1 para cadastro, 2 para consultar, 3 para exclusao, " +
        ...
        while (!isOpcaoValida(opcao)) {
            ...
            opcao = JOptionPane.showInputDialog(null, "Opcao invalida ! Digite 1 para cadastro, 2 para consultar, 3 para exclusao, " +
                    "4 para alteração ou 5 para sair", "Green dinner", JOptionPane.INFORMATION_MESSAGE);
        }
